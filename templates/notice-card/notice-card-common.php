...
if ( ! empty( $args ) ) :
	...
	$pnpnd_icon_class       = isset( $args['icon_class'] ) ? $args['icon_class'] : '';
	$pnpnd_card_status      = isset( $args['card_status'] ) ? $args['card_status'] : 'primary';
	$pnpnd_primary_button   = isset( $args['primary_button'] ) ? (array) $args['primary_button'] : array();
	$pnpnd_secondary_button = isset( $args['secondary_button'] ) ? (array) $args['secondary_button'] : array();
	...
	<div class="pnpnd-top-level-wrapper <?php echo esc_attr( $pnpnd_wrapper_class ); ?>">
		<div class="pnpnd-notice-card flex-center rounded-md pnpnd-notice-status-<?php echo esc_attr( $pnpnd_card_status ); ?>">
			<div class="pnpnd-notice-card-wrapper flex-center flex-col">
				<?php if ( ! empty( $pnpnd_icon ) || ! empty( $pnpnd_icon_class ) ) : ?>
					<span class="pnpnd-icon pnpnd-notice-card-wrapper-icon <?php echo esc_attr( $pnpnd_icon_class ); ?>"><?php echo esc_html( $pnpnd_icon ); ?></span>
				<?php endif; ?>
