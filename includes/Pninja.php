...
use Pninja\ND\API\ApiRegistry;
use Pninja\ND\Integrations\Forms\ContactForm7;

use function sprintf;

defined( 'ABSPATH' ) || exit( 'No direct script access allowed' );

use Pninja\ND\Integrations\Blocks;
use Pninja\ND\Integrations\Elementor;
use Pninja\ND\Utils\Singleton;
use Pninja\ND\Widget\Locations;
...
class Pninja {
	...
	public function actionLinks( $links ) {
		$links[] = sprintf( '<a target="_blank" href="%s">%s</a>', admin_url( 'admin.php?page=ninja-drive#/settings' ), __( 'Settings', 'ninja-drive' ) );
