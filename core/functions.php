...
if ( ! function_exists( 'pnpndGetAccountByKey' ) ) {
	/**
	 * Retrieve an account by its key.
	 *
	 * @param string $key The key of the account to retrieve.
	 * @return \Pninja\ND\App\Account|WP_Error
	 */
	function pnpndGetAccountByKey( $key ) {
		$account = \Pninja\ND\App\Accounts::getInstance()->getAccountByKey( $key );

		return $account;
	}
}

if ( ! function_exists( 'pnpndGetFileByKey' ) ) {
	/**
	...
	function pnpndGetFileByKey( $key ) {
		$file = \Pninja\ND\Models\Files::getInstance()->getFileByKey( $key, 'array' );

		return $file;
	}
}

if ( ! function_exists( 'pnpndGetFileIdsByKeys' ) ) {
	...
	function pnpndGetFileIdsByKeys( array $keys ) {
		return \Pninja\ND\Models\Files::getInstance()->getFileAttributesByKeys( $keys );
	}
}

if ( ! function_exists( 'pnpndGetFileAttributesByKeys' ) ) {
	/**
	...
	function pnpndGetFileAttributesByKeys( array $keys, array $attributes ) {
		return \Pninja\ND\Models\Files::getInstance()->getFileAttributesByKeys( $keys, $attributes );
	}
}

if ( ! function_exists( 'pnpndGetExtensionGroups' ) ) {
	/**
...
if ( ! function_exists( 'pnpndGetExtensionByMimeType' ) ) {
	/**
...
if ( ! function_exists( 'pnpndGetMimeTypeByExtension' ) ) {
	/**
...
if ( ! function_exists( 'pnpndGetMimeTypesByGroup' ) ) {
	/**
...
if ( ! function_exists( 'pnpndGetMimeTypeMap' ) ) {
	/**
...
if ( ! function_exists( 'pnpndGetDefaultSettings' ) ) {
...
if ( ! function_exists( 'pnpndGetWidgetDefaultData' ) ) {
...
if ( ! function_exists( 'pnpndDeepMergeWithUnset' ) ) {
	/**
...
if ( ! function_exists( 'pnpndGetWidgetTypesSchema' ) ) {
...
if ( ! function_exists( 'pnpndGetTablesDefinitions' ) ) {
...
if ( ! function_exists( 'pnpndGetAllowedWidgetExtensions' ) ) {
...
if ( ! function_exists( 'pnpndGetTemplate' ) ) {
...
if ( ! function_exists( 'pnpndTitleToUrlSlug' ) ) {
...
if ( ! function_exists( 'pnpndGetUrl' ) ) {
	/**
...
if ( ! function_exists( 'pnpndGetWidgets' ) ) {
...
if ( ! function_exists( 'pnpndGetAvailableThumbnailSizes' ) ) {
