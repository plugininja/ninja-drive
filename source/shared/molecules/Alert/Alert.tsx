...
function AlertComponent(props: AlertState & { inTray?: boolean }) {
    const {
        ...
        confirmButtonText = __("OK", "ninja-drive"),
        cancelButtonText = __("Cancel", "ninja-drive"),
        showIcon = true,
        timer,
    ...
    const inputClasses = ["pn-alert-input", errorMessage && "error"]
        .filter(Boolean)
        .join(" ");
        ...
        >
            ...
            {showCloseButton && (
                <button
                    ...
                    className={clsx("pn-alert-close-button")}
